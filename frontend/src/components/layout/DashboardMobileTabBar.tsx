...
export function DashboardMobileTabBar({
  ...
  if (trainingLocked) {
    ...
    return (
      <nav
        className="shrink-0 border-t border-border/70 bg-background pb-[max(0.35rem,env(safe-area-inset-bottom))] shadow-[0_-8px_20px_-14px_rgba(2,6,23,0.35)] md:hidden"
        role="navigation"
        aria-label="Training"
      >
