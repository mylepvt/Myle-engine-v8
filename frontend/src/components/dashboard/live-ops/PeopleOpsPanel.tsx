...
function LeaderCard({ leader, rank }: { leader: LeaderHealthItem; rank: number }) {
  ...
  return (
    <Link to={`/dashboard/team/tracking/${leader.leader_id}`} className="flex min-w-[100px] flex-1 flex-col items-center gap-2 rounded border border-white/[0.06] bg-white/[0.03] p-3 text-center no-underline transition-all duration-150 hover:border-white/20 hover:bg-white/[0.07] active:bg-white/[0.1] cursor-pointer">
      {/* Rank badge */}
      <div
