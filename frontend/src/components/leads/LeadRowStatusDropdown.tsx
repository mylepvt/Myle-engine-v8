  ...
  return (
    <div className="relative min-w-0">
      <button
        ...
        className={cn(
          'flex h-8 w-full max-w-full items-center justify-between gap-1 rounded-md border border-border dark:border-white/12 bg-muted/50 px-2 text-left text-xs text-foreground shadow-glass-inset',
