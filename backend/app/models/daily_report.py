...
class DailyReport(Base):
    ...
    day1_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    day2_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    day3_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
