  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-1 pb-1">
        <span className="inline-flex items-center gap-1.5 text-ds-label uppercase text-foreground/55">
        ...
        <span className="text-[0.65rem] tabular-nums text-foreground/40">Session</span>
      </div>
