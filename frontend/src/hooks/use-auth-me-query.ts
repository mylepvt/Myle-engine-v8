...
export type MeResponse = {
  ...
  /** When true, the onboarding tutorial walkthrough should be shown. */
  tutorial_pending: boolean | null
...
export async function fetchAuthMe(): Promise<MeResponse> {
  ...
  const normalize = (raw: Partial<MeResponse>): MeResponse => ({
    ...
    tutorial_pending:
      typeof raw.tutorial_pending === 'boolean' ? raw.tutorial_pending : null,
